...
search_criteria = (2017, 1.6, 35000)

#________________________ code __________________________________


suitable_cars_list = [] # create empty list for end result

for car, specification in car_data.items(): # use cycle for
  color, year, engine_volume, car_type, price = specification # unpacking 'specification' data
  if year >= search_criteria[0] and engine_volume >= search_criteria[1] and price <= search_criteria[2]: # create conditions
...
# display_cars_in_column(sorted_by_price) variant 1
# print('variant_1')
# print(sorted_by_price[:5])
